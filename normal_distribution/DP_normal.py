...
H0 = 0.0 # The intial levee height (meter)
...
# climate scenarios
NA = 1 # number of climate scenarios
AS = 0.0/100
# variation of a stationary climate scenario    
MU = np.zeros(n)
    ...
    # existing levee height l
        ...
        # upgrading levee height m
            ...
            # expected annual total cost only exists when existing + upgrading height is no greater than maximum height
                (EATC[i][l][m]) = annualtotalcost( existh, upgradh, mu ) * ( 1/((1+R)**i) )
